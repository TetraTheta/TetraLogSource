...
{{< gallery/image src="033" w=80% >}}

170 연차. 이로하가 나왔다.

이로하 역시 진작에 전무 3성을 달고 있다.

{{< gallery/image src="034" w=80% >}}

180 연차. 또다시 시로코 테러가 나왔다.

어째 시로코 테러가 무장 호시노보다 자주 나오는 것 같다?

{{< gallery/image src="035" w=80% >}}
