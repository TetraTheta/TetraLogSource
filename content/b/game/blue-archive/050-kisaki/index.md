...
대결전이나 제약해제결전을 하지 않았기에, 10 연차 티켓이 단 하나밖에 없다.
...
저번에 말했듯이, 스토리에서 "당신 같은 어른이 제일 싫습니다"라고 말한 주제에 픽업에서 다른 RABBIT 소대원보다 더 자주 나오는 녀석이다.
...
아까 RABBIT 소대 이야기를 꺼냈다고 나온 건가? 그럴 거면 차라리 모에가 나왔으면 좋았을 텐데. 그러면 RABBIT 소대 전원이 모이는 거 아냐.

{{< gallery/image src="011|012|013" >}}

모집 포인트를 키사키 엘레프에 투자할지 아니면 레이죠에 투자할지 잠시 고민했다.

하지만 저번에 이치카/카스미 픽업에서 카스미에 올인했다가 한동안 이치카가 나오지 않아 후회했던 일이 생각나, 레이죠에 투자했다.

![](014.webp)

여태껏 키울만한 산해경 캐릭터가 나오지 않았기에, 키사키의 스킬과 장비를 최대한 키울 수 있었다.

키사키의 성급을 올리는 건 최대한 스케줄로 키사키 엘레프를 확보한 후, 카이텐져 총력전 바로 직전에 올리라는 조언을 들었다. 그래야 엘리그마를 아낄 수 있다고 했던가.

***

이번 픽업이 페스인 건 아니지만, 가챠 성과를 확인하고 싶어졌다.
