...
> 「――投影, 开始」 ({{< ruby "투영, 개시" "Trace on" >}})
{.bq}

오타쿠라면 못 알아볼 리 없는 에미야 시로의 명대사이다. 그런데 명조는 이걸 '――홀로그램, 스타트'라고 번역했더라. 소아온의 "링크, 스타트" 패러디인 줄 알았다는 사람도 있었으니, 말 다했지.
...
번역의 기조 역시 혐오스럽기 그지없다. 그놈의 한영혼용체.
